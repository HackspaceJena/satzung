...
\begin{enumerate}
    ...
    \item Eine Fördermitgliedschaft mit einem Beitrag von 0\euro{} ist eine
        satzungskonforme Möglichkeit einer assoziierten oder
        Ehrenmitgliedschaft. Damit kann ein Ausschluss vermieden werden, wenn
        sich verdiente oder langfristig verhinderte Mitglieder dem Verein
        weiterhin verbunden fühlen, die Betragszahlung für sie aber nicht mehr
        sinnvoll erscheint und sie auch nicht mehr als ordentliche Mitglieder
        z.B. bei der Bestimmung der Beschlussfähigkeit zählen sollen.
\end{enumerate}
